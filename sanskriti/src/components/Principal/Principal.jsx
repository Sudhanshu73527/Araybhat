        ...
        >
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl xl:text-[56px] font-medium leading-[1.15] mb-10">
              {" "}
              Educating Minds. <br /> Shaping Character. <br /> Building the
              Future.{" "}
            </h2>{" "}
            ...
            <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-7 max-w-2xl">
              ...
              At our institution, we go beyond academics to cultivate
              discipline, integrity, confidence, and purpose in every student.{" "}
            </p>{" "}
            <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-7 max-w-2xl">
              {" "}
            ...
            <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-12 max-w-2xl">
              ...
              environment where excellence is nurtured, effort is respected, and
              success is achieved with humility.{" "}
            </p>{" "}
