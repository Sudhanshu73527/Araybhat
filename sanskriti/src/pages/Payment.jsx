      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 mt-3 text-lg">
            Kindly complete your admission payment using the details below to
            confirm your registration successfully.
          </p>
        </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 p-8 md:p-10">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Please make the payment using the bank account or UPI details
                  provided.
                </p>

                <p>
                  After successful payment, your admission registration will be
                  verified by the school administration.
                </p>

                <p>
                  Keep your payment screenshot or transaction ID safe for future
                  verification.
                </p>
              </div>
              ...
              <div className="mt-8 bg-green-50 border border-green-100 rounded-2xl p-6">
                ...
                <p className="text-5xl font-bold text-green-600">₹2,400</p>
